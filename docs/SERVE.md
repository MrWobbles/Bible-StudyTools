...
2. Right-click on `student.html` and select "Open with Live Server"
3. This will open the display page at `http://localhost:5500/student.html`
...
Then open:
- Display: `http://localhost:8000/student.html`
...
Then open:
- Display: `http://localhost:8080/student.html`
